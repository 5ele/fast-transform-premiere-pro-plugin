...
export declare type SequenceEditor = {
	...
	createInsertProjectItemAction(
		...
		limitShift: boolean,
	): Action; //Create insert ProjectItem into Sequence Action. Note: If you pass a track index greater than the number of existing tracks, a new track will be created.
